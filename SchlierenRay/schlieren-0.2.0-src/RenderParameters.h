 ...
 struct RenderParameters
{
    ...
    float3 min_bound, max_bound;	// min and max bounds for the volume with density gradients
	float3 data_min_bound, data_max_bound;	// min and max bounds for the volume in physical space (from nrrd file)
