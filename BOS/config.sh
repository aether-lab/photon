...
cmake $SRC_DIR -DCMAKE_INSTALL_PREFIX:PATH=$INSTALL_DIR \
 ...
 -DCMAKE_CXX_FLAGS:STRING="-I /home/barracuda/a/lrajendr/SchlierenRayVis/SchlierenRay/cuda-samples/NVIDIA_CUDA-7.0_Samples/common/inc -L /usr/include -lbz2 -lpng -L/usr/lib64 -lbz2 -lpng -I $SRC_DIR" 
